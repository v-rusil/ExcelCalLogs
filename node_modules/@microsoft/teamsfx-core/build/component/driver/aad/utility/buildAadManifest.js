...
const missingEnvInFileError_1 = require("../error/missingEnvInFileError");
...
async function loadManifest(manifestPath, state) {
    ...
    try {
        ...
        if (unresolvedEnvironmentVariable && unresolvedEnvironmentVariable.length > 0) {
            throw new missingEnvInFileError_1.MissingEnvInFileUserError(actionName, unresolvedEnvironmentVariable, helpLink, driverConstants.generateManifestFailedMessageKey, manifestPath);
        }
