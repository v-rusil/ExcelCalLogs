...
export declare function getBlobUri(storageName: string): string;
export declare function getBlobServiceClient(blobUri: string, sasToken: string): Promise<BlobServiceClient>;
