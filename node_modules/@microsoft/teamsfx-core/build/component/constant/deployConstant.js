...
exports.ProgressBarConstant = exports.DeployStatus = exports.DeployConstant = void 0;
...
class ProgressBarConstant {
}
exports.ProgressBarConstant = ProgressBarConstant;
ProgressBarConstant.ZIP_DEPLOY_IN_AZURE_PROGRESS = [
    messages_1.ProgressMessages.packingCode,
    messages_1.ProgressMessages.getAzureAccountInfoForDeploy,
    messages_1.ProgressMessages.getAzureUploadEndpoint,
    messages_1.ProgressMessages.uploadZipFileToAzure,
    messages_1.ProgressMessages.checkAzureDeployStatus,
    messages_1.ProgressMessages.restartAzureFunctionApp,
];
ProgressBarConstant.DRY_RUN_ZIP_DEPLOY_IN_AZURE_PROGRESS = [messages_1.ProgressMessages.packingCode];
ProgressBarConstant.UPLOAD_DEPLOY_TO_AZURE_STORAGE_PROGRESS = [
    messages_1.ProgressMessages.getAzureStorageAccountInfo,
    messages_1.ProgressMessages.clearStorageExistsBlobs,
    messages_1.ProgressMessages.uploadFilesToStorage,
];
