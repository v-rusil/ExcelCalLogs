...
export declare class ProgressBarConstant {
    static readonly ZIP_DEPLOY_IN_AZURE_PROGRESS: string[];
    static readonly DRY_RUN_ZIP_DEPLOY_IN_AZURE_PROGRESS: string[];
    static readonly UPLOAD_DEPLOY_TO_AZURE_STORAGE_PROGRESS: string[];
}
