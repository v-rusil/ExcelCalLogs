    ...
    async getInstallationInfo(installOptions) {
        ...
        try {
            ...
            if (currentVersion === null) {
                ...
                const error = new depsError_1.NodeNotFoundError(message_1.Messages.NodeNotFound()
                    .split("@NodeVersion")
                    .join(supportedVersions[supportedVersions.length - 1]), this._nodeNotFoundHelpLink);
