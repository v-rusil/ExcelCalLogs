...
export declare class NodeNotLtsError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class V3NodeNotSupportedError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class LinuxNotSupportedError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class PortableFuncNodeNotMatchedError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class GlobalFuncNodeNotMatchedError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class BackendExtensionsInstallError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
export declare class VxTestAppCheckError extends DepsCheckerError {
    constructor(message: string, helpLink: string);
}
